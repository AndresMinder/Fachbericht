...
\includepdf[pages={1},nup=1x1,landscape=true,scale=0.85,offset=0 -40,pagecommand={\section{Schema}\label{pdf:schema}\thispagestyle{myheadings}}]{graphics/schema_und_layout/schematic.pdf} 
...
\includepdf[pages={1},nup=1x1,landscape=true,scale=0.85,offset=0 -40,pagecommand={\section{PCB-Design (Top View)}\label{pdf:pcb}\thispagestyle{myheadings}}]{graphics/schema_und_layout/pcb_design.pdf}
